    ...
    <CavosProvider
      config={{
        ...
        socialRecoveryAttestation: {
          audience: process.env.NEXT_PUBLIC_CAVOS_RECOVERY_AUDIENCE,
          imageDigest: process.env.NEXT_PUBLIC_CAVOS_RECOVERY_IMAGE_DIGEST,
          projectNumber: process.env.NEXT_PUBLIC_CAVOS_RECOVERY_PROJECT_NUMBER,
          serviceAccount: process.env.NEXT_PUBLIC_CAVOS_RECOVERY_SERVICE_ACCOUNT,
        },
      }}
      modal={{
        appName: "My App",

...
- **Three chain adapters:** **Starknet**, **Solana**, and **Stellar** (classic `G…` multisig) share the unified API. See [Chains](/docs/chains). React Native hardware compatibility remains gated on physical-device E2E validation.

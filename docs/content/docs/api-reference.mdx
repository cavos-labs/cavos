...
interface ConnectOptions {
  ...
  passkeyPrf?: PasskeyPrfProvider;        // PRF derives the MasterDEK (single-chain)
...
native, PRF is the MasterDEK KDF (can spend). Login never prompts. See
...
| `PasskeyPrf` | WebAuthn PRF helper. Native Solana/Stellar KDF. |
...
| `PasskeyPrf`, `PasskeyPrfOptions`, `PasskeyPrfEnrollParams` | WebAuthn PRF helper (MasterDEK KDF / grandfathered extra signer). |

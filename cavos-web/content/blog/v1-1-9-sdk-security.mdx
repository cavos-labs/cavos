...
> **Historical release note.** This article documents the legacy
> `@cavos/react` JWT/session-key architecture. New integrations should use
> `@cavos/kit`, Cavos' every-chain device-native SDK. Starknet, Solana, and
> Stellar are currently available; see the
> [current documentation](https://docs.cavos.xyz).

            ...
            <div className="max-w-3xl mx-auto px-6 md:px-8 pt-32 pb-24">
                ...
                <div className="bg-[#F7F5F2] border border-[#EAE5DC] rounded-2xl p-6 md:p-10 space-y-0">
                    ...
                    <Section num={3} title="Plans, fees, and billing (Stripe)">
                        ...
                        <p>
                            <strong className="text-black/80">Taxes.</strong> Fees are as displayed at checkout. Stripe may collect and remit taxes that it is required by law to collect. Except for amounts Stripe actually collects and remits, you are responsible for taxes arising from your purchase or use of the Services. These Terms do not state that Cavos collects Costa Rican IVA or any other VAT as a registered tax collector.
                        </p>
                        <p>

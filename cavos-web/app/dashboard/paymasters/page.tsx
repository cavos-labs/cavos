...
export default function PaymastersPage() {
    ...
    return (
        <div className="space-y-6 animate-fadeIn max-w-4xl">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-baseline gap-2">
                            <span className="text-5xl font-bold tracking-tighter tabular-nums text-ink">{availableBalance.toFixed(4)}</span>
                            <span className="text-lg font-bold text-black/35">STRK</span>
                        </div>
            ...
            {/* ── Propulsion Grant Banner — light ── */}
            <div className="rounded-2xl bg-surface border border-line p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
                ...
                <div className="flex-1 min-w-0">
                    <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-black/40 mb-1.5">Starknet Propulsion</p>
                    <p className="text-lg md:text-xl font-bold text-ink tracking-tight leading-snug">Apply for the Propulsion Grant and get your gas for free</p>
                </div>
                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody>
                                {deposits.map((deposit) => (
                                    <tr key={deposit.id} className="border-t border-line/60 hover:bg-surface/50 transition-colors">

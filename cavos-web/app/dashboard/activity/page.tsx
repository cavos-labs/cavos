...
export default function ActivityPage() {
  ...
  return <div className="space-y-6"><PageHeader eyebrow="Operations" title="Activity" subtitle="Operational events produced or coordinated by Cavos. Retained for 30 days." />
...
function Status({ value }: { value: string }) {
  const variant = value === 'success' ? 'ok' : value === 'failed' ? 'danger' : 'warn'
